...
//            e.printStackTrace();
//        }
    	Object[] objArray = {doctor.getDoctorName(), doctor.getSpeciality(), doctor.getExperience(), doctor.getRatings(), doctor.getConsultationFees()};
    	jdbcTemplate.update(Queries.INSERTQUERY, objArray);
    }

    @Override
    public void updateDoctor(double consultationFees, int doctorId) {
    	jdbcTemplate.update(Queries.UPDATEQUERY, consultationFees, doctorId);
//        try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public Doctor findDoctorById(int doctorId) {
    	return (Doctor) jdbcTemplate.queryForList(Queries.FINDBYID, new DoctorMapper(), doctorId);
...
//        return doctor;
    ...
    public List<Doctor> findAll() {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
        List<Doctor> doctors = jdbcTemplate.query(Queries.SELECTALL, doctorMapper);
//        try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public List<Doctor> findBySpeciality(String speciality) {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
        List<Doctor> doctorsBySpeciality = jdbcTemplate.query(Queries.FINDBYSPECIALITY, doctorMapper, speciality);
//        try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public List<Doctor> findBySpecialityAndExp(String speciality, int experience) {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
       List<Doctor> doctorsBySpecAndExp = jdbcTemplate.query(Queries.FINDBYSPECANDEXP, doctorMapper, speciality, experience);
//       try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public List<Doctor> findBySpecialityAndLessFees(String speciality, double fees) {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
        List<Doctor> doctorsBySpecAndFeesLessThan = jdbcTemplate.query(Queries.FINDBYSPECANDFEES, doctorMapper, speciality, fees);
//       try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public List<Doctor> findBySpecialityAndRatings(String speciality, int ratings) {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
        List<Doctor> doctorsBySpecAndRatings = jdbcTemplate.query(Queries.FINDBYSPECANDRATINGS, doctorMapper, speciality, ratings);
//       try (
//            Connection connection = DoctorDB.openConnetion();
...
//        }
    ...
    public List<Doctor> findBySpecialityAndNameContains(String speciality, String doctorName) {
    	RowMapper<Doctor> doctorMapper = new DoctorMapper();
        List<Doctor> doctorsBySpecAndNameContains = jdbcTemplate.query(Queries.FINDBYSPECANDNAMECONTAINS, doctorMapper, speciality, doctorName);
//       try (
//            Connection connection = DoctorDB.openConnetion();
